...
export function createDesktopPlatformBuildConfig(
  ...
  if (input.platform === "mac") {
    ...
    const mac = {
      ...
      // The afterSign hook notarizes the app before electron-builder creates the
      // update ZIP and DMG; the build script then notarizes and staples the DMG.
      notarize: false,
    ...
    return {
      ...nativePackaging,
      ...(input.signed === true && macSigningMode !== "adhoc"
        ? {
