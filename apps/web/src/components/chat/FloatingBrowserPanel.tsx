  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div className="pointer-events-auto flex items-center gap-0.5 rounded-full border border-border bg-popover/95 p-0.5 text-ui-sm text-muted-foreground shadow-sm backdrop-blur-xl">
            <IconButton
              type="button"
              variant="ghost"
              size="icon-xs"
